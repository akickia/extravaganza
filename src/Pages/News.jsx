...
export default function News() {
  return (
    <article className="page page-video">
      ...
      <section className='page-content page-intro'><p>Vår värld av spänning och underhållning växer ständigt. Utforska våra senaste attraktioner, magiska shower och specialhändelser här på Extravaganza! Varje besök är en ny möjlighet till äventyr.</p></section>
